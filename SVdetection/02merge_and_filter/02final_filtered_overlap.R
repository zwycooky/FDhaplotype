...
svdat <- read.table("syri.sniffiles.merged.sv.txt",header=F)
...
write.table(filtered_svdat,"syri.sniffiles.merged.sv.final.txt", row.names=F,col.names=F,sep="\t",quote=F)
